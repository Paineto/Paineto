...
?>
	<div id="container">
		...
		<form id="main" name="form" class="wufoo " autocomplete="on" method="POST">
			...
			<p>Click <a href="addsupplier.php">here</a> to go ADD new supplier.	
			<center><h1><font color='maroon'>Suppliers</font></h1>
...
<?
	...
	while($row = mysql_fetch_object($result)){
		if($color=="#DDFCDA"){
			...
			name=\"image\" src=\"images/delete.gif\" onclick=\"popupWindow('membersview.php?id=".$row->id."&view=2')\"width=\"20\" height=\"20\">view</td>";
			$color="#98EC66";
		}
		else
		{
